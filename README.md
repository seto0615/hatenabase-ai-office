...
社員には氏名があります。役割を表す苗字＋ひと癖ある名前という付け方です。

| 部署（島） | 氏名 | 読み | 役職 |
|---|---|---|---|
| PM席 | 段取 八分 | だんどり はちぶ | PM |
| コーポレート部 | 勘定 合致 | かんじょう がっち | アカウンタント |
| コーポレート部 | 適材 適所 | てきざい てきしょ | リクルーター |
| インテリジェンス部 | 裏取 万全 | うらどり ばんぜん | リサーチャー |
| インテリジェンス部 | 天邪 鬼助 | あまのじゃ きすけ | レッドチーム（反証） |
| インテリジェンス部 | 議事 録美 | ぎじ ろくみ | アーキビスト |
| コミュニケーション部 | 商談 成太 | しょうだん なるた | セールス |
| コミュニケーション部 | 一筆 啓上 | いっぴつ けいじょう | メールライター |
| コミュニケーション部 | 拡散 希望 | かくさん のぞむ | パブリッシャー |
| クリエイティブ部 | 紙芝 居作 | かみしば いさく | デッキビルダー |
| クリエイティブ部 | 意匠 凝人 | いしょう こりと | デザイナー |
| クリエイティブ部 | 誤字 拾雄 | ごじ ひろお | エディター |
