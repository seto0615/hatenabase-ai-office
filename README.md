...
社長が指示を出すと、PMが受け取って分解し、AI社員が並行して働くバーチャルオフィスです。
ビルの断面図の上で、誰がいま何をしているかが見えます。作業が終わった社員は席を立ち、
報告書がシャフトを上がってPM室へ、最後にPMが社長室へ上げます。
...
|---|---|---|---|
| RF | 社長室 | 世戸口 | 指示を出す（人間） |
| 5F | PM室 | PM | 分解・割り振り・統合・品質管理 |
| 4F | コーポレート部 | アカウンタント | 会計・税務・数値の検証 |
| 4F | コーポレート部 | リクルーター | 採用要件・JD・スカウト文 |
| 3F | インテリジェンス部 | リサーチャー | 一次情報の調査（Web検索可） |
| 3F | インテリジェンス部 | レッドチーム | 反証・別視点（Web検索可） |
| 3F | インテリジェンス部 | アーキビスト | 議事録・Slackログの読解と構造化 |
| 2F | コミュニケーション部 | セールス | 商談設計・提案ストーリー |
| 2F | コミュニケーション部 | メールライター | メール・チャット文面 |
| 2F | コミュニケーション部 | パブリッシャー | X投稿・セミナー告知 |
| 1F | クリエイティブ部 | デッキビルダー | 提案資料・レポートのHTML制作 |
| 1F | クリエイティブ部 | デザイナー | デザインシステムの管理と適用 |
| 1F | クリエイティブ部 | エディター | トンマナと事実の最終チェック |
